{
  ...
  packages = [
    ...
    {
      name = "_iconify_json___json_2.2.92.tgz";
      path = fetchurl {
        name = "_iconify_json___json_2.2.92.tgz";
        url = "https://registry.yarnpkg.com/@iconify/json/-/json-2.2.92.tgz";
        sha512 = "90skjzsGcOObfKIkRc+JWjMdI+BI8jfB5tbXk825+aNscWwDYSCuEaN2EWaDnmHHB+S2bMXQbUDeBoQiUjojcA==";
      };
    }
    {
