{
  ...
  packages = [
    ...
    {
      name = "_iconify_json___json_2.2.68.tgz";
      path = fetchurl {
        name = "_iconify_json___json_2.2.68.tgz";
        url = "https://registry.yarnpkg.com/@iconify/json/-/json-2.2.68.tgz";
        sha512 = "UNgbecms1tWhvY9ycXbWW/nOLlx5Xxlufp+dHWontty0j+yiQfap3UshpSGGAt74C9OLYEFKTl42d20PLRakzg==";
      };
    }
    {
