{
  ...
  packages = [
    ...
    {
      name = "_iconify_json___json_2.2.150.tgz";
      path = fetchurl {
        name = "_iconify_json___json_2.2.150.tgz";
        url = "https://registry.yarnpkg.com/@iconify/json/-/json-2.2.150.tgz";
        sha512 = "SltvXzHpr919VfTXlxYaO9hWIOZnDl3DMnqdB+BVsh2nHs7QkKHEdimx3XhDmX5wJAKg7gup7sGDwwh9P3aTqQ==";
      };
    }
    {
