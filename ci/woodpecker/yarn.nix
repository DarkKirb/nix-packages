{
  ...
  packages = [
    ...
    {
      name = "_types_node___node_18.17.19.tgz";
      path = fetchurl {
        name = "_types_node___node_18.17.19.tgz";
        url = "https://registry.yarnpkg.com/@types/node/-/node-18.17.19.tgz";
        sha512 = "+pMhShR3Or5GR0/sp4Da7FnhVmTalWm81M6MkEldbwjETSaPalw138Z4KdpQaistvqQxLB7Cy4xwYdxpbSOs9Q==";
      };
    }
    {
