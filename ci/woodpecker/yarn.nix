{
  ...
  packages = [
    ...
    {
      name = "_iconify_json___json_2.2.146.tgz";
      path = fetchurl {
        name = "_iconify_json___json_2.2.146.tgz";
        url = "https://registry.yarnpkg.com/@iconify/json/-/json-2.2.146.tgz";
        sha512 = "Z+kOCjsQSivgphCsaHM7Qg/vjGAzY1QXNREv2JllTh3Wn68LcDS4cie+nox2pfrnF/41B4UM6OI2CrZ00AU2Sg==";
      };
    }
    {
