{ fetchurl, fetchgit, linkFarm, runCommand, gnutar }: rec {
  ...
  packages = [
    ...
    {
      name = "_eslint_community_regexpp___regexpp_4.8.1.tgz";
      path = fetchurl {
        name = "_eslint_community_regexpp___regexpp_4.8.1.tgz";
        url  = "https://registry.yarnpkg.com/@eslint-community/regexpp/-/regexpp-4.8.1.tgz";
    ...
    {
      name = "_iconify_json___json_2.2.115.tgz";
      path = fetchurl {
        name = "_iconify_json___json_2.2.115.tgz";
        url  = "https://registry.yarnpkg.com/@iconify/json/-/json-2.2.115.tgz";
        sha512 = "WeU73CQ57pCZsINbRVz2UFeHDhLUeCY6OgteFceZ06xtAykRoHMcI/JILT23hav/00yThGPJ6mcvkYLLbyoCUQ==";
      };
    }
    {
    ...
    {
      name = "_kyvg_vue3_notification___vue3_notification_3.0.1.tgz";
      path = fetchurl {
        name = "_kyvg_vue3_notification___vue3_notification_3.0.1.tgz";
        url  = "https://registry.yarnpkg.com/@kyvg/vue3-notification/-/vue3-notification-3.0.1.tgz";
        sha512 = "6g4Sm03PM1Cc0atHHqQk5+ZtekXaxEXf9YVhfTv9FnUiNYKdquwVMuysj0cJabobsNSQSOASjqMg3+ndV2SqWw==";
      };
    }
    {
    ...
    {
      name = "_types_node___node_18.17.15.tgz";
      path = fetchurl {
        name = "_types_node___node_18.17.15.tgz";
        url  = "https://registry.yarnpkg.com/@types/node/-/node-18.17.15.tgz";
    ...
    {
      name = "_types_semver___semver_7.5.2.tgz";
      path = fetchurl {
        name = "_types_semver___semver_7.5.2.tgz";
        url  = "https://registry.yarnpkg.com/@types/semver/-/semver-7.5.2.tgz";
        sha512 = "7aqorHYgdNO4DM36stTiGO3DvKoex9TQRwsJU6vMaFGyqpBA1MNZkz+PG3gaNUPpTAOYhT1WR7M1JyA3fbS9Cw==";
      };
    }
    {
    ...
    {
      name = "_typescript_eslint_eslint_plugin___eslint_plugin_6.7.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_eslint_plugin___eslint_plugin_6.7.0.tgz";
        url  = "https://registry.yarnpkg.com/@typescript-eslint/eslint-plugin/-/eslint-plugin-6.7.0.tgz";
        sha512 = "gUqtknHm0TDs1LhY12K2NA3Rmlmp88jK9Tx8vGZMfHeNMLE3GH2e9TRub+y+SOjuYgtOmok+wt1AyDPZqxbNag==";
      };
    }
    {
      name = "_typescript_eslint_parser___parser_6.7.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_parser___parser_6.7.0.tgz";
        url  = "https://registry.yarnpkg.com/@typescript-eslint/parser/-/parser-6.7.0.tgz";
        sha512 = "jZKYwqNpNm5kzPVP5z1JXAuxjtl2uG+5NpaMocFPTNC2EdYIgbXIPImObOkhbONxtFTTdoZstLZefbaK+wXZng==";
      };
    }
    {
      name = "_typescript_eslint_scope_manager___scope_manager_6.7.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_scope_manager___scope_manager_6.7.0.tgz";
        url  = "https://registry.yarnpkg.com/@typescript-eslint/scope-manager/-/scope-manager-6.7.0.tgz";
        sha512 = "lAT1Uau20lQyjoLUQ5FUMSX/dS07qux9rYd5FGzKz/Kf8W8ccuvMyldb8hadHdK/qOI7aikvQWqulnEq2nCEYA==";
      };
    }
    {
      name = "_typescript_eslint_type_utils___type_utils_6.7.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_type_utils___type_utils_6.7.0.tgz";
        url  = "https://registry.yarnpkg.com/@typescript-eslint/type-utils/-/type-utils-6.7.0.tgz";
        sha512 = "f/QabJgDAlpSz3qduCyQT0Fw7hHpmhOzY/Rv6zO3yO+HVIdPfIWhrQoAyG+uZVtWAIS85zAyzgAFfyEr+MgBpg==";
      };
    }
    {
      name = "_typescript_eslint_types___types_6.7.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_types___types_6.7.0.tgz";
        url  = "https://registry.yarnpkg.com/@typescript-eslint/types/-/types-6.7.0.tgz";
        sha512 = "ihPfvOp7pOcN/ysoj0RpBPOx3HQTJTrIN8UZK+WFd3/iDeFHHqeyYxa4hQk4rMhsz9H9mXpR61IzwlBVGXtl9Q==";
      };
    }
    {
      name = "_typescript_eslint_typescript_estree___typescript_estree_6.7.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_typescript_estree___typescript_estree_6.7.0.tgz";
        url  = "https://registry.yarnpkg.com/@typescript-eslint/typescript-estree/-/typescript-estree-6.7.0.tgz";
        sha512 = "dPvkXj3n6e9yd/0LfojNU8VMUGHWiLuBZvbM6V6QYD+2qxqInE7J+J/ieY2iGwR9ivf/R/haWGkIj04WVUeiSQ==";
      };
    }
    {
      name = "_typescript_eslint_utils___utils_6.7.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_utils___utils_6.7.0.tgz";
        url  = "https://registry.yarnpkg.com/@typescript-eslint/utils/-/utils-6.7.0.tgz";
        sha512 = "MfCq3cM0vh2slSikQYqK2Gq52gvOhe57vD2RM3V4gQRZYX4rDPnKLu5p6cm89+LJiGlwEXU8hkYxhqqEC/V3qA==";
      };
    }
    {
      name = "_typescript_eslint_visitor_keys___visitor_keys_6.7.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_visitor_keys___visitor_keys_6.7.0.tgz";
        url  = "https://registry.yarnpkg.com/@typescript-eslint/visitor-keys/-/visitor-keys-6.7.0.tgz";
        sha512 = "/C1RVgKFDmGMcVGeD8HjKv2bd72oI1KxQDeY8uc66gw9R0OK0eMq48cA+jv9/2Ag6cdrsUGySm1yzYmfz0hxwQ==";
      };
    }
    {
    ...
    {
      name = "_volar_language_core___language_core_1.10.1.tgz";
      path = fetchurl {
        name = "_volar_language_core___language_core_1.10.1.tgz";
        url  = "https://registry.yarnpkg.com/@volar/language-core/-/language-core-1.10.1.tgz";
        sha512 = "JnsM1mIPdfGPxmoOcK1c7HYAsL6YOv0TCJ4aW3AXPZN/Jb4R77epDyMZIVudSGjWMbvv/JfUa+rQ+dGKTmgwBA==";
      };
    }
    {
      name = "_volar_source_map___source_map_1.10.1.tgz";
      path = fetchurl {
        name = "_volar_source_map___source_map_1.10.1.tgz";
        url  = "https://registry.yarnpkg.com/@volar/source-map/-/source-map-1.10.1.tgz";
        sha512 = "3/S6KQbqa7pGC8CxPrg69qHLpOvkiPHGJtWPkI/1AXCsktkJ6gIk/5z4hyuMp8Anvs6eS/Kvp/GZa3ut3votKA==";
      };
    }
    {
      name = "_volar_typescript___typescript_1.10.1.tgz";
      path = fetchurl {
        name = "_volar_typescript___typescript_1.10.1.tgz";
        url  = "https://registry.yarnpkg.com/@volar/typescript/-/typescript-1.10.1.tgz";
    ...
    {
      name = "_vue_language_core___language_core_1.8.11.tgz";
      path = fetchurl {
        name = "_vue_language_core___language_core_1.8.11.tgz";
        url  = "https://registry.yarnpkg.com/@vue/language-core/-/language-core-1.8.11.tgz";
    ...
    {
      name = "_vue_typescript___typescript_1.8.11.tgz";
      path = fetchurl {
        name = "_vue_typescript___typescript_1.8.11.tgz";
        url  = "https://registry.yarnpkg.com/@vue/typescript/-/typescript-1.8.11.tgz";
    ...
    {
      name = "caniuse_lite___caniuse_lite_1.0.30001534.tgz";
      path = fetchurl {
        name = "caniuse_lite___caniuse_lite_1.0.30001534.tgz";
        url  = "https://registry.yarnpkg.com/caniuse-lite/-/caniuse-lite-1.0.30001534.tgz";
    ...
    {
      name = "electron_to_chromium___electron_to_chromium_1.4.520.tgz";
      path = fetchurl {
        name = "electron_to_chromium___electron_to_chromium_1.4.520.tgz";
        url  = "https://registry.yarnpkg.com/electron-to-chromium/-/electron-to-chromium-1.4.520.tgz";
    ...
    {
      name = "rollup___rollup_3.29.1.tgz";
      path = fetchurl {
        name = "rollup___rollup_3.29.1.tgz";
        url  = "https://registry.yarnpkg.com/rollup/-/rollup-3.29.1.tgz";
    ...
    {
      name = "vue_tsc___vue_tsc_1.8.11.tgz";
      path = fetchurl {
        name = "vue_tsc___vue_tsc_1.8.11.tgz";
        url  = "https://registry.yarnpkg.com/vue-tsc/-/vue-tsc-1.8.11.tgz";
