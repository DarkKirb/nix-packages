{
  ...
  packages = [
    ...
    {
      name = "rollup___rollup_3.24.0.tgz";
      path = fetchurl {
        name = "rollup___rollup_3.24.0.tgz";
        url = "https://registry.yarnpkg.com/rollup/-/rollup-3.24.0.tgz";
        sha512 = "OgraHOIg2YpHQTjl0/ymWfFNBEyPucB7lmhXrQUh38qNOegxLapSPFs9sNr0qKR75awW41D93XafoR2QfhBdUQ==";
      };
    }
    {
