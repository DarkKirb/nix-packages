{
  ...
  packages = [
    ...
    {
      name = "stylelint___stylelint_14.10.0.tgz";
      path = fetchurl {
        name = "stylelint___stylelint_14.10.0.tgz";
        url = "https://registry.yarnpkg.com/stylelint/-/stylelint-14.10.0.tgz";
        sha512 = "VAmyKrEK+wNFh9R8mNqoxEFzaa4gsHGhcT4xgkQDuOA5cjF6CaNS8loYV7gpi4tIZBPUyXesotPXzJAMN8VLOQ==";
      };
    }
    {
